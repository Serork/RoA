...
sealed class Fog2 : AdvancedDust<Fog2> {
    ...
    public override void Draw(ref ParticleRendererSettings settings, SpriteBatch spritebatch) {
        ...
        spritebatch.Draw(Texture, Position - Main.screenPosition, Frame, lightColor * MathUtils.Clamp01(_brightness * (1f - Alpha / 255f)) 
            * Utils.GetLerpValue(0f, 1f, FadeIn, true) * Utils.GetLerpValue(FadeIn2, FadeIn2 * 0.9f, FadeIn, true), Rotation, Origin, Scale, SpriteEffects.None, 0f);
    }
