...
sealed class TulipBlast : NatureProjectile {
    ...
    public override bool PreDraw(ref Color lightColor) {
        ...
        //for (int k = 0; k < Projectile.OldUseItemPos.Length; k++) {
        //    Vector2 drawPos = (Projectile.OldUseItemPos[k] - Main.screenPosition) + drawOrigin + new Vector2(0f, Projectile.gfxOffY);
        //    DrawColor color = Projectile.GetAlpha(lightColor) * ((Projectile.OldUseItemPos.Length - k) / (float)Projectile.OldUseItemPos.Length);
