...
sealed class MeltingStar : ModProjectile {
    ...
    public override bool PreDraw(ref Color lightColor) {
        ...
        //Texture2D backTexture = (Texture2D)ModContent.Request<Texture2D>(ResourceManager.Textures + "Light");
        //spriteBatch.Draw(backTexture, Projectile.Center - Main.screenPosition, new Rectangle?(), Color.FromNonPremultiplied(byte.MaxValue, 255, 0, 50) * Projectile.Opacity, 0.0f, backTexture.Size() / 2f, (float)(0.8f + 0.2f * Math.Sin(Main.time / 10)) * 0.75f, SpriteEffects.None, 0.0f);
