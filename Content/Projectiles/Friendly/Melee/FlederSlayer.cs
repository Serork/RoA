...
sealed class FlederSlayer : ModProjectile, DruidPlayerShouldersFix.IProjectileFixShoulderWhileActive {
    ...
    public override void AI() {
        ...
        if (!player.IsAliveAndFree()) {
            ...
            Projectile.Center = Utils.Floor(player.MountedCenter) + Vector2.Normalize(Projectile.velocity);
    ...
    public override bool PreDraw(ref Color lightColor) {
        ...
        spriteBatch.Draw(sparkTexture2D,
                            center + offset + position2 * Projectile.scale - Main.screenPosition + new Vector2(0f, Main.player[Projectile.owner].gfxOffY),
                            null,
