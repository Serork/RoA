    ...
    public override void AI() {
        ...
        if (Projectile.localAI[0] % 3f == 0f) {
            if (Projectile.owner == Main.myPlayer) {
                ...
                Projectile.NewProjectile(Projectile.GetSource_FromAI(), Projectile.Center/* - Vector2.UnitX * 1080f*/ + new Vector2((60 + duration * 2.5f) * Projectile.ai[1], 0) - velocity * 8, velocity, ModContent.ProjectileType<JudgementSlash>(), Projectile.damage, Projectile.knockBack, Projectile.owner);
            }
        }
    }
}
