...
sealed class ChemicalFlask : ModProjectile {
    ...
    public override bool PreDraw(ref Color lightColor) {
        ...
        color3.A = 150;
        Main.EntitySpriteDraw(texture, position, sourceRectangle, color3 * 0.25f * Helper.Wave(0.5f, 1f, 10f, Projectile.identity), Projectile.rotation, origin, Projectile.scale * 2.25f * Helper.Wave(0.95f, 1.1f, 5f, Projectile.identity), spriteEffects);
