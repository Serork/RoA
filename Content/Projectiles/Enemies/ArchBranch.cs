...
sealed class ArchBranch : ModProjectile {
    ...
    public override void AI() {
        ...
        for (int i = 0; i < 8; i++) {
            ...
            int dust = Dust.NewDust(Projectile.oldPos[i] + Projectile.Size / 2f - Vector2.One * 2, 4, 4, ModContent.DustType<ArchdruidDust>(), 0f, 0f, 255, Scale: 0.8f);
    ...
    public override void OnKill(int timeLeft) {
        ...
        for (int i = 0; i < 5; i++) {
            int dust = Dust.NewDust(Projectile.position - Projectile.velocity * 1f, 0, 0, ModContent.DustType<ArchdruidDust>(), 0, 0, 255, Scale: 0.8f);
