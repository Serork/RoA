    ...
    public override void ModifyWorldGenTasks(List<GenPass> tasks, ref double totalWeight) {
        tasks.Insert(tasks.FindIndex(task => task.Name == "Settle Liquids") + 1, new PassLegacy("Tar", delegate (GenerationProgress progress, GameConfiguration passConfig) {
            ...
            while (num919 < num916) {
                ...
                Point point3 = WorldGen.RandomRectanglePoint((int)(num920 * (double)(Main.maxTilesX - 200)) + 200, (int)GenVars.worldSurface + 200, (int)num917, (int)GenVars.rockLayer - (int)GenVars.worldSurface - 50);
                //if (remixWorldGen)
