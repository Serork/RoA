...
sealed class TarBiome : MicroBiome {
    ...
    public override bool Place(Point origin, StructureMap structures) {
        ...
        structures.AddProtectedStructure(GeometryUtils.CenteredSquare(origin.ToVector2() + new Vector2(effectedMapArea.Size().X * 1.05f + 5, effectedMapArea.Size().Y - 5) * 0.625f, effectedMapArea.Size()), 8);
        return true;
    }
