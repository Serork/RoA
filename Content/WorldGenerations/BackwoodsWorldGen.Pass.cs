...
sealed class BackwoodsBiomePass(string name, double loadWeight) : GenPass(name, loadWeight) {
    ...
    private void Step0_Setup() {
        ...
        while (!flag50) {
            ...
            if (num794 > GenVars.dungeonLocation - num786 * 2.5 && num795 < GenVars.dungeonLocation + num786 * 2.5)
                flag50 = false;
