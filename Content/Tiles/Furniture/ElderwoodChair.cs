...
sealed class ElderwoodChair : ModTile {
	...
	public override void SetStaticDefaults() {
		...
		// name.SetDefault("Elderwood Chair");
	...
	public override void KillMultiTile(int i, int j, int TileFrameX, int TileFrameY) {
		//int item = Item.NewItem(new EntitySource_TileBreak(i, j), i * 16, j * 16, 34, 38, ModContent.ItemType<Items.Placeable.Furniture.ElderwoodChair>(), 1, false, 0, false, false);
