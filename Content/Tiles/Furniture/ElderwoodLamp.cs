...
sealed class ElderwoodLamp : ModTile {
    ...
    public override void PostDraw(int i, int j, SpriteBatch spriteBatch) {
        ...
        for (int c = 0; c < 7; c++) {
            ...
            Main.spriteBatch.Draw(flameTexture, pos + new Vector2(-offsetX, 0), new Rectangle(tile.TileFrameX, tile.TileFrameY, 16, 16), new Color(100, 100, 100, 0), 0f, default, 1f, effects, 0f);
        }
    }
}
