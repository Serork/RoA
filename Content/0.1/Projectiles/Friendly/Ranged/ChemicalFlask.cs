...
sealed class ChemicalFlask : ModProjectile {
    ...
    public override bool PreDraw(ref Color lightColor) {
        ...
        for (int k = 0; k < Projectile.oldPos.Length; k++) {
            ...
            //spriteBatch.DrawSelf(ModContent.Request<Texture2D>(Texture + "_Glow").Value, drawPos, null, Color.White * ((Projectile.oldPos.Length - k) / (float)Projectile.oldPos.Length), Projectile._rotation, drawOrigin, Projectile.scale, SpriteEffects.None, 0f);
        }
