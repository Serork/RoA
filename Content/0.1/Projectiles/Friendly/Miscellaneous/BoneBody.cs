...
sealed class BoneBody : ModProjectile {
    ...
    public override void OnKill(int timeLeft) {
        ...
        ushort _type = (ushort)ModContent.ProjectileType<BoneBody_Back>();
...
sealed class BoneBody_Back : SkeletonBodyPart {
    public override string Texture => ProjectileLoader.GetProjectile(ModContent.ProjectileType<BoneBody>()).Texture;
}