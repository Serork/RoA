...
sealed class Coral : NatureProjectile_NoTextureLoad {
    ...
    public override void AI() {
        ...
        void makeBubbleDusts() {
            ...
            if (Main.rand.NextChance(chance * 2f)) {
                Dust.NewDustDirect(dustSpawnPosition, spawnAreaWidth, spawnAreaHeight, DustID.Water, SpeedX: dustVelocity.X, SpeedY: dustVelocity.Y - 10f * Main.rand.NextFloat(), Scale: 1.25f - 0.25f * Main.rand.NextFloat());
            }
        }
