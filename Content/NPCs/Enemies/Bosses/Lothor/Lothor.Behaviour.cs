...
sealed partial class Lothor : ModNPC {
    ...
    private void ActualDeath(bool flag = false) {
        ...
        if (Main.netMode != NetmodeID.MultiplayerClient) {
            ...
            NPC.NewNPC(NPC.GetSource_Death(), (int)(NPC.Center.X + origin.X), (int)(NPC.Center.Y + origin.Y), ModContent.NPCType<LothorSoul>());
        }

        if (Main.netMode != NetmodeID.MultiplayerClient) {
            Vector2 origin = new(0f, 35f);
            NPC.NewNPC(NPC.GetSource_Death(), (int)(NPC.Center.X + origin.X), (int)(NPC.Center.Y + origin.Y), ModContent.NPCType<Lothor2>());
        }
    }
