...
sealed class Lumberjack : ModNPC {
    ...
    private ref float CurrentFrame => ref NPC.localAI[0];
    ...
    private void ChangeFrame((int, int) frameInfo)  => NPC.frame.Y = frameInfo.Item1 * frameInfo.Item2;

    private void ChangeState(int stateID, bool changeFrame = true, bool keepState = true) {
	...
	public override void AI() {
		...
		switch (State) {
			...
			case (float)States.Walking:
				...
				if (NPC.velocity.Y >= 0f && !NPC.collideY && !NPC.collideX) {
