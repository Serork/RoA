...
static class WorldGenHelper {
    ...
    public static bool Place1x3Top(int x, int y, ushort type, int styleX = 0, int styleY = 0, Action<Point16>? onPlace = null) {
        if (WorldGen.SolidTile2(x, y - 1) && !Main.tile[x, y].HasTile && !Main.tile[x, y + 1].HasTile && !Main.tile[x, y + 2].HasTile) {
            short num = (short)(styleY * 36);
            short num2 = (short)(styleX * 18);
            Tile tile = Main.tile[x, y];
            tile.HasTile = true;
            ...
            tile.TileFrameX = num2;
            tile.TileType = type;
            tile = Main.tile[x, y + 2];
            tile.HasTile = true;
            tile.TileFrameY = (short)(num + 36);
            tile.TileFrameX = num2;
            tile.TileType = type;
