...
public abstract class Metaball : ModType {
    ...
    public virtual void BeforeDrawingTarget(SpriteBatch spriteBatch) { }
    ...
    public virtual void PrepareShaderForTarget(int layerIndex) {
        ...
        var metaballShader = ShaderLoader.MetaballEdgeShader.Value;
        ...
        Main.instance.GraphicsDevice.Textures[1] = layerTexture;
