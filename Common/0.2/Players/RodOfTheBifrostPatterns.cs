...
sealed partial class PlayerCommon : ModPlayer {
    ...
    public static Dictionary<PatternType, BifrostFigureType[]> Patterns { get; private set; } = new Dictionary<PatternType, BifrostFigureType[]> {
        { PatternType.Pattern1, new BifrostFigureType[] { BifrostFigureType.Green2, BifrostFigureType.Blue2, BifrostFigureType.Purple3, BifrostFigureType.Blue1, BifrostFigureType.Purple2, BifrostFigureType.Orange1 } },
