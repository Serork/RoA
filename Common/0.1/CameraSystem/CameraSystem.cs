...
//    internal static AsymetricalPanModifier AsymetricalPanModifier = new();
...
//    public static void AsymetricalPan(int durationOut, int durationHold, int durationIn, Vector2 from, Vector2 target, Func<Vector2, Vector2, float, Vector2> easeOut = null, Func<Vector2, Vector2, float, Vector2> easeIn = null) {
...
//        AsymetricalPanModifier.from = from;
