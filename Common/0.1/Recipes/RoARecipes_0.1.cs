...
sealed partial class RoARecipes : ModSystem {
    private static Dictionary<Type, Recipe> _wreathRecipesAdded = [];

    private static Recipe GetAddedWreathRecipe<T>() where T : WreathItem => _wreathRecipesAdded[typeof(T)];

    public override void Unload() => _wreathRecipesAdded.Clear();

    private static void V01Recipes() {
        V01AddElderwoodItems();
        V01AddDynastyWoodItems();
        V01AddHellstoneItems(out Recipe daikatana);
        V01AddMercuriumItems(daikatana);
        V01AddFlamingFabricItems();
        V01AddGalipotItems();
        V01AddHerbItems();
        V01AddPlanterBoxes();
        V01AddOtherSawmill();
        V01AddWreaths(out Recipe lastWreath);
        V01AddDruidItems(lastWreath);
        V01AddCopperSets();
        V01AddBoneHarpySet();
        V01AddCorruptionRelatedStuff();
        V01AddCrimsonRelatedStuff();
        V01AddTinkererWorkShopItems();
        V01AddFood();
        V01AddTerrarium();
        V01AddIceBiomeItems();
        V01AddTrappedChests();
    ...
    private static void V01AddOther() {
    ...
    private static void V01AddCampfire() {
    ...
    private static void V01AddTorch() {
    ...
    private static void V01AddTrappedChests() {
    ...
    private static void V01AddIceBiomeItems() {
    ...
    private static void V01AddTerrarium() {
    ...
    private static void V01AddFood() {
    ...
    private static void CompleteWreathCraftAchievement(Recipe recipe, Item item, List<Item> consumedItems, Item destinationStack) {
    ...
    private static void V01AddWreaths(out Recipe lastWreath) {
        ref Dictionary<Type, Recipe> wreaths = ref _wreathRecipesAdded;

        Recipe item = Recipe.Create(ModContent.ItemType<ForestWreathTier1>());
        ...
        item.Register();
        Recipe temp = item;
        item = Recipe.Create(ModContent.ItemType<ForestWreathTier2>());
        ...
        item.AddOnCraftCallback(CompleteWreathCraftAchievement);
        item.Register();
        wreaths.Add(typeof(ForestWreathTier2), temp);

        temp = item;
        item = Recipe.Create(ModContent.ItemType<JungleWreathTier1>());
        item.AddIngredient<TwigWreath>(1);
        ...
        item.AddOnCraftCallback(CompleteWreathCraftAchievement);
        temp = item;
        item = Recipe.Create(ModContent.ItemType<JungleWreathTier2>());
        ...
        item.AddOnCraftCallback(CompleteWreathCraftAchievement);
        item.Register();
        wreaths.Add(typeof(JungleWreathTier2), temp);

        temp = item;
        item = Recipe.Create(ModContent.ItemType<BeachWreathTier1>());
        item.AddIngredient<TwigWreath>(1);
        ...
        item.Register();
        temp = item;
        item = Recipe.Create(ModContent.ItemType<BeachWreathTier2>());
        ...
        item.AddOnCraftCallback(CompleteWreathCraftAchievement);
        item.Register();
        wreaths.Add(typeof(BeachWreathTier2), temp);

        temp = item;
        item = Recipe.Create(ModContent.ItemType<SnowWreathTier1>());
        item.AddIngredient<TwigWreath>(1);
        ...
        item.Register();
        temp = item;
        item = Recipe.Create(ModContent.ItemType<SnowWreathTier2>());
        ...
        item.AddOnCraftCallback(CompleteWreathCraftAchievement);
        item.Register();
        wreaths.Add(typeof(SnowWreathTier2), temp);
    ...
    private static void V01AddTinkererWorkShopItems() {
    ...
    private static void V01AddCrimsonRelatedStuff() {
    ...
    private static void V01AddCorruptionRelatedStuff() {
    ...
    private static void V01AddBoneHarpySet() {
    ...
    private static void V01AddCopperSets() {
    ...
    private static void V01AddDruidItems(Recipe lastWreath) {
    ...
    private static void V01AddOtherSawmill() {
    ...
    private static void V01AddPlanterBoxes() {
    ...
    private static void V01AddHerbItems() {
    ...
    private static void V01AddGalipotItems() {
        // slippery items
    ...
    private static void V01AddFlamingFabricItems() {
        // armor
    ...
    private static void V01AddHellstoneItems(out Recipe daikatana) {
    ...
    private static void V01AddMercuriumItems(Recipe starFusion) {
    ...
    private static void V01AddDynastyWoodItems() {
    ...
    private static void V01AddElderwoodItems() {
