...
sealed class WreathHandler : ModPlayer {
    ...
    public static Color SoulOfTheWoodsBaseColor => new(255, 255, 255, 125);
    ...
    internal void SlowlyFill2() {
        ...
        if (CannotToggleOrGetWreathCharge) {
            if (_currentChangingMult < 0.1f * DruidPlayerStats.DischargeTimeDecreaseMultiplier * _extraChangingValueMultiplier) {
                Dusts_ResetStayTime();
